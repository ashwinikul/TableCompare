...
'''    
old = pd.read_excel('Input/Data1.csv', 'Sheet1', na_values=['NA'])
new = pd.read_excel('Input/Data1.csv', 'Sheet1', na_values=['NA'])
'''
old = pd.read_excel('Input/Data1.xlsx', 'Sheet1', na_values=['NA'])
new = pd.read_excel('Input/Data2.xlsx', 'Sheet1', na_values=['NA'])
old['version'] = "old"
new['version'] = "new"
...
writer = pd.ExcelWriter("Output/Compare.xlsx")
